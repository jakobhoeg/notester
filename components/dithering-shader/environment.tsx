 ...
 */
export function Room({ highlight }: RoomProps): React.JSX.Element {
  return (
...
export function EnvironmentWrapper({ intensity, highlight }: EnvironmentWrapperProps): React.JSX.Element {
  return (
